...
//               <div
//                 key={index}
//                 className={`group flex items-center space-x-3 bg-white/80 p-4 rounded-xl hover:bg-green-100 transition-all duration-300 hover:scale-105 ${
...
const AboutSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="py-32 bg-emerald-50 relative overflow-hidden"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-emerald-100/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-emerald-100/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            <div className="mb-6">
              ...
              >
                <Sparkles size={16} className="mr-2 text-emerald-600" />
                Innovation Meets Tradition
              </span>
            </div>

            <h2
              className={`text-5xl md:text-5xl font-bold text-slate-900 mb-8 leading-tight transition-all duration-700 delay-300 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
            >
              Scaling new heights through{" "}
              <span className="text-emerald-600 relative">
                science
                <div className="absolute -bottom-3 left-0 w-full h-1.5 bg-gradient-to-r from-emerald-400 to-emerald-600 rounded-full transform scale-x-0 animate-[scaleX_1s_ease-out_1.5s_forwards]"></div>
              </span>
            </h2>

            <div className="space-y-6 mb-10">
              <p
                className={`text-lg text-slate-600 leading-relaxed transition-all duration-700 delay-500 ${
                  isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
                }`}
              >
                We're all about pushing boundaries while staying grounded. We explore the cutting edge of food science
              ...
              <p
                className={`text-lg text-slate-600 leading-relaxed transition-all duration-700 delay-700 ${
                  isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
                }`}
              >
                Our ambition? To innovate with purpose — delivering flavour that's not only exciting but also
            ...
            >
              <div className="flex items-center text-emerald-600 font-semibold text-lg group-hover:text-emerald-700 transition-all duration-300">
                <span className="mr-4 group-hover:mr-5 transition-all duration-300">Learn about our process</span>
                <ArrowRight
                  size={24}
                  className="transform group-hover:translate-x-2 transition-transform duration-300"
              ...
              <div className="w-0 group-hover:w-64 h-1 bg-gradient-to-r from-emerald-600 to-emerald-400 transition-all duration-500 mt-2 rounded-full"></div>
            </div>
          </div>
          ...
          >
            <div className="relative">
              {/* Main card */}
              <div className="bg-white rounded-3xl px-8 py-10 shadow-xl border border-emerald-200 relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
                {/* Animated background pattern */}
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/10 to-emerald-100/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                {/* Floating elements */}
                <div className="absolute top-6 right-6 w-3 h-3 bg-emerald-400 rounded-full animate-ping"></div>
                <div className="absolute bottom-8 left-8 w-2 h-2 bg-emerald-500 rounded-full animate-pulse delay-500"></div>
                ...
                <div className="grid grid-cols-2 gap-10 relative z-10 mb-8">
                  ...
                  >
                    <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover/item:shadow-xl group-hover/item:scale-110 transition-all duration-300 group-hover/item:rotate-3">
                      <Leaf className="text-white drop-shadow-sm" size={32} />
                    </div>
                    <h3 className="text-4xl font-bold text-slate-900 mb-3 group-hover/item:text-emerald-700 transition-colors duration-300">
                      90+
                    </h3>
                    <p className="text-slate-600 font-medium text-lg">Years of Expertise</p>
                    <div className="w-0 group-hover/item:w-full h-1 bg-emerald-400 mx-auto mt-3 transition-all duration-500 rounded-full"></div>
                  </div>
                  ...
                  >
                    <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover/item:shadow-xl group-hover/item:scale-110 transition-all duration-300 group-hover/item:-rotate-3">
                      <Award className="text-white drop-shadow-sm" size={32} />
                    </div>
                    <h3 className="text-4xl font-bold text-slate-900 mb-3 group-hover/item:text-emerald-700 transition-colors duration-300">
                      100+
                    </h3>
                    <p className="text-slate-600 font-medium text-lg">Flavour Solutions</p>
                    <div className="w-0 group-hover/item:w-full h-1 bg-emerald-400 mx-auto mt-3 transition-all duration-500 rounded-full"></div>
                  </div>
                </div>
                ...
                {/* Additional stat */}
                <div
                  className={`pt-8 border-t border-emerald-200 text-center transition-all duration-500 delay-1400 ${
                    isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  }`}
                >
                  ...
                  <p className="text-slate-600 text-sm">Leading the industry in eco-friendly seasoning solutions</p>
                </div>
              </div>

              {/* Floating accent elements */}
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-emerald-400 rounded-full opacity-20 animate-bounce delay-1000"></div>
              <div className="absolute -bottom-3 -left-3 w-6 h-6 bg-emerald-500 rounded-full opacity-30 animate-pulse delay-1500"></div>
            </div>
          </div>
        </div>
        ...
        {/* Values Section */}
        <div
          className={`bg-white rounded-3xl p-12 shadow-lg border border-emerald-200 transition-all duration-1000 delay-2400 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
          }`}
        >
          <div className="text-center mb-10">
