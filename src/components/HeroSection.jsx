...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-100 to-green-200 relative overflow-hidden mt-20"
    >
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="animate-in fade-in slide-in-from-bottom duration-1000">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
            Yashasveeni Seasoning sees flavour as a force for transformation — rooted in science, powered by innovation, and
            guided by purpose.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="bg-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-gradient-to-r from-green-50 to-green-100 transform  transition-all hover:text-green-600 duration-300 shadow-lg hover:shadow-xl hover:border-2 border-green-600">
              Explore Solutions
            </button>
