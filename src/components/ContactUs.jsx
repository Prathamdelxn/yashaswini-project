        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div className="space-y-6">
              ...
              {/* CTA Card */}
              <div
                className={`bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-green-100/50 text-center transition-all duration-500 delay-1500 ${
                  isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <Sparkles size={32} className="text-green-600 mx-auto mb-3" />
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Ready to innovate together?</h3>
                <p className="text-gray-600 text-sm">
                  Let's discuss how we can help transform your food products with our seasoning solutions.
                </p>
              </div>
            </div>
          </div>
